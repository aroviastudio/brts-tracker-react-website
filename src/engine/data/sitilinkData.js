...
export const INITIAL_BUS_FLEET = [
  // 15C Fleet (Clockwise)
  {
    busId: 'BUS_15C_1502',
    routeId: '15C',
    busNumber: 'GJ-05-BX-1502',
    currentStopId: 'ST_PARVAT',
    nextStopId: 'ST_AASPASS',
    destinationStopId: 'ST_SOMESHWAR',
    status: 'EN_ROUTE',
    passengerCount: 4,
    speedKmh: 31,
    heading: 42,
    direction: 'Someshwar Junction (Direct)',
    source: 'CROWDSOURCED'
  },
  {
    busId: 'BUS_15C_1508',
    routeId: '15C',
    busNumber: 'GJ-05-BX-1508',
    currentStopId: 'ST_ALTHAN',
    nextStopId: 'ST_ANUVRAT',
    destinationStopId: 'ST_SOMESHWAR',
    status: 'DEPARTED_DEPOT',
    passengerCount: 2,
    speedKmh: 28,
    heading: 50,
    direction: 'Someshwar via Kharwar (Loop)',
    source: 'CROWDSOURCED'
  },
  {
    busId: 'BUS_15C_1514',
    routeId: '15C',
    busNumber: 'GJ-05-BX-1514',
    currentStopId: 'ST_GODADARA',
    nextStopId: 'ST_DINDOLI_BRIDGE',
    destinationStopId: 'ST_ALTHAN',
    status: 'RETURN_LOOP',
    passengerCount: 3,
    speedKmh: 35,
    heading: 190,
    direction: 'Althan Depot via Dindoli Loop',
    source: 'CROWDSOURCED'
  },

  // 15AC Fleet (Anti-Clockwise)
  {
    busId: 'BUS_15AC_1501',
    routeId: '15AC',
    busNumber: 'GJ-05-BX-1501',
    currentStopId: 'ST_DINDOLI_BRIDGE',
    nextStopId: 'ST_GODADARA',
    destinationStopId: 'ST_SOMESHWAR',
    status: 'EN_ROUTE',
    passengerCount: 5,
    speedKmh: 33,
    heading: 38,
    direction: 'Someshwar Junction (via Dindoli)',
    source: 'CROWDSOURCED'
  },
  {
    busId: 'BUS_15AC_1507',
    routeId: '15AC',
    busNumber: 'GJ-05-BX-1507',
    currentStopId: 'ST_PARVAT',
    nextStopId: 'ST_KHARWAR',
    destinationStopId: 'ST_ALTHAN',
    status: 'EN_ROUTE',
    passengerCount: 3,
    speedKmh: 29,
    heading: 235,
    direction: 'Althan Depot (via Kharwar)',
    source: 'CROWDSOURCED'
  },
  ...
  // Route 11 Fleet
  {
    busId: 'BUS_11_1104',
    routeId: '11',
    busNumber: 'GJ-05-BX-1104',
    currentStopId: 'ST_KHARWAR',
    nextStopId: 'ST_UNN_PATIYA',
    destinationStopId: 'ST_SACHIN_GIDC',
    status: 'EN_ROUTE',
    passengerCount: 6,
    speedKmh: 36,
    heading: 185,
    direction: 'Sachin GIDC Terminal',
  ...
  // Route 12 Fleet
  {
    busId: 'BUS_12_1208',
    routeId: '12',
    busNumber: 'GJ-05-BX-1208',
    currentStopId: 'ST_MAJURA_GATE',
    nextStopId: 'ST_SURAT_STATION',
    destinationStopId: 'ST_SARTHANA',
    status: 'EN_ROUTE',
    passengerCount: 5,
    speedKmh: 27,
    heading: 15,
    direction: 'Sarthana Nature Park (Zoo)',
    source: 'LIVE OFFICIAL'
  },

  // Route 106 Electric Bus Fleet
  {
    busId: 'BUS_106_EV02',
    routeId: '106',
    busNumber: 'GJ-05-EV-1002',
    currentStopId: 'ST_SVNIT',
    nextStopId: 'ST_VR_MALL',
    destinationStopId: 'ST_DUMAS_RESORT',
    status: 'EN_ROUTE',
    passengerCount: 7,
    speedKmh: 38,
    heading: 220,
    direction: 'Dumas Resort Terminal (EV)',
    source: 'LIVE OFFICIAL'
  }
];
